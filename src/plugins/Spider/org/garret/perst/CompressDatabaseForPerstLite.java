...
public class CompressDatabaseForPerstLite {
    ...
    public static void compress(OutputStream out, InputStream in, String cipherKey)
            throws IOException {
        int rc;
    ...
    public static void main(String[] args) throws IOException {
        if ((args.length == 0) || (args.length > 2)) {
            System.err.println(
                "Usage: java plugins.Spider.org.garret.perst.CompressDatabaseForPerstLite DATABASE_FILE_PATH [cipher-key]");
