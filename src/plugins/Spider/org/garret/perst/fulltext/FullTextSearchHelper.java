        ...
        int scan() {
            ...
            while (p < len) {
                ...
                if (ch == '"') {
                    ...
                    wordPos = p;
                    while ((++p < len) &&
                            (Character.isLetter(q.charAt(p)) || Character.isDigit(q.charAt(p))));
    ...
    protected FullTextQuery term(QueryScanner scanner) {
        ...
        switch (scanner.scan()) {
            ...
            case QueryScanner.TKN_WORD :
                q = new FullTextQueryMatchOp(scanner.inQuotes
                                             ? FullTextQuery.STRICT_MATCH
                                             : FullTextQuery.MATCH, scanner.word, scanner.wordPos);
