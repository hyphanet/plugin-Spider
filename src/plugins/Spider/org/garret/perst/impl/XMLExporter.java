...
public class XMLExporter {
                        ...
                        if ((mask & bit) != 0) {
                            ...
                            try {
                                ...
                                if (desc.cls == Btree.class) {
                                    exportIndex(oid, obj,
                                                "plugins.Spider.org.garret.perst.impl.Btree");
                                } else if (desc.cls == BitIndexImpl.class) {
                                    exportIndex(
                                        oid, obj,
                                        "plugins.Spider.org.garret.perst.impl.BitIndexImpl");
                                } else if (desc.cls == PersistentSet.class) {
                                    exportSet(oid, obj);
                                } else if (desc.cls == BtreeFieldIndex.class) {
                                    exportFieldIndex(
                                        oid, obj,
                                        "plugins.Spider.org.garret.perst.impl.BtreeFieldIndex");
                                    ...
                                    exportMultiFieldIndex(
                                        oid, obj,
                                        "plugins.Spider.org.garret.perst.impl.BtreeMultiFieldIndex");
                                ...
                                if (storage.listener != null) {
                                    ...
                                    System.err.println("XML export failed for object " + oid +
                                                       ": " + x);
                                }
                            }
                        }
    ...
    final void exportCompoundIndex(int oid, byte[] data) throws IOException {
        ...
        storage.assignOid(btree, oid);
        writer.write(" <plugins.Spider.org.garret.perst.impl.BtreeCompoundIndex id=\"" + oid +
                     "\" unique=\"" + (btree.unique ? '1' : '0') + "\"");
        ...
        for (int i = 0, n = all.length; i < n; i++) {
            ...
            switch (fd.type) {
                ...
                case ClassDescriptor.tpFloat :
                    ...
                    break;
                case ClassDescriptor.tpDouble :
                    writer.write(Double.toString(Double.longBitsToDouble(Bytes.unpack8(body,
                            offs))));
                    offs += 8;
                ...
                case ClassDescriptor.tpArrayOfBoolean : {
                    ...
                    if (len < 0) {
                        ...
                        while (--len >= 0) {
                            ...
                            writer.write("<element>" + ((body[offs++] != 0) ? "1" : "0") +
                                         "</element>\n");
                        }
                ...
                case ClassDescriptor.tpArrayOfChar : {
                    ...
                    if (len < 0) {
                        ...
                        while (--len >= 0) {
                            indentation(indent + 1);
                            writer.write("<element>" + (Bytes.unpack2(body, offs) & 0xFFFF) +
                                         "</element>\n");
                            offs += 2;
                        }
                    ...
                    if (len < 0) {
                        ...
                        while (--len >= 0) {
                            ...
                            if (ordinal < 0) {
                                ...
                                writer.write("<element>\"" + enumConstants[ordinal].name() +
                                             "\"</element>\n");
                            }
