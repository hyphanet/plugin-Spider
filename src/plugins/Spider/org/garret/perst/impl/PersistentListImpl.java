...
class PersistentListImpl<E extends IPersistent> extends PersistentCollection<E>
    ...
    static class ListIntermediatePage extends ListPage {
        ...
        void copy(int dstOffs, ListPage src, int srcOffs, int len) {
            ...
            System.arraycopy(((ListIntermediatePage) src).nChildren, srcOffs, nChildren, dstOffs,
                             len);
        }
