...
public final class ClassDescriptor extends Persistent {
    ...
    static final String signature[] = {
        ...
        "Object", "Value", "Raw", "Link", "enum", "", "", "", "", "", "", "ArrayOfBoolean",
        "ArrayOfByte", "ArrayOfChar", "ArrayOfShort", "ArrayOfInt", "ArrayOfLong", "ArrayOfFloat",
        "ArrayOfDouble", "ArrayOfEnum", "ArrayOfString", "ArrayOfDate", "ArrayOfObject",
        "ArrayOfValue", "ArrayOfRaw", "ArrayOfLink", "ArrayOfEnum"
    };
    ...
    static boolean treateAnyNonPersistentObjectAsValue =
        Boolean.getBoolean("perst.implicit.values");
    ...
    public static String getClassName(Class cls) {
        ...
        return (loader instanceof INamedClassLoader)
               ? ((INamedClassLoader) loader).getName() + ':' + cls.getName() : cls.getName();
    }
