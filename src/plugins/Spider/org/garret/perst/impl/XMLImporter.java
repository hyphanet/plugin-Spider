...
public class XMLImporter {
    ...
    public void importDatabase() throws XMLImportException {
        ...
        while ((tkn = scanner.scan()) == XMLScanner.XML_LT) {
            ...
            if (elemName.equals("plugins.Spider.org.garret.perst.impl.Btree") || elemName.equals(
                    "plugins.Spider.org.garret.perst.impl.BitIndexImpl") || elemName.equals(
                    "plugins.Spider.org.garret.perst.impl.PersistentSet") || elemName.equals(
                    "plugins.Spider.org.garret.perst.impl.BtreeFieldIndex") || elemName.equals(
                    "plugins.Spider.org.garret.perst.impl.BtreeCaseInsensitiveFieldIndex") || elemName.equals(
                    "plugins.Spider.org.garret.perst.impl.BtreeCompoundIndex") || elemName.equals(
                    "plugins.Spider.org.garret.perst.impl.BtreeMultiFieldIndex") || elemName.equals(
                    "plugins.Spider.org.garret.perst.impl.BtreeCaseInsensitiveMultiFieldIndex")) {
    ...
    final void createIndex(String indexType) throws XMLImportException {
        ...
        while ((tkn = scanner.scan()) == XMLScanner.XML_IDENT) {
            ...
            if ((scanner.scan() != XMLScanner.XML_EQ) ||
                    (scanner.scan() != XMLScanner.XML_SCONST)) {
        ...
        if (className != null) {
            ...
            if (fieldName != null) {
                if (indexType.equals(
                        "plugins.Spider.org.garret.perst.impl.BtreeCaseInsensitiveFieldIndex")) {
            ...
            if (types != null) {
                ...
                if (indexType.equals("plugins.Spider.org.garret.perst.impl.PersistentSet")) {
                    btree = new PersistentSet();
                } else {
                    throwException("Key type is not specified for index");
                }
            } else {
                if (indexType.equals("plugins.Spider.org.garret.perst.impl.BitIndexImpl")) {
        ...
        if ((elem == null) || elem.isNullValue()) {
            ...
            if (hexStr.startsWith("#")) {
                ...
                for (int j = 2; j < len; j += 2) {
                    buf.arr[offs++] = (byte) ((getHexValue(hexStr.charAt(j)) << 4)
                                              | getHexValue(hexStr.charAt(j + 1)));
                }
            } else {
        ...
        for (int i = 0, n = flds.length; i < n; i++) {
            ...
            switch (fd.type) {
                case ClassDescriptor.tpByte :
                    ...
                    if (elem != null) {
                        if (elem.isIntValue()) {
                            ...
                            throwException("Conversion for field " + fieldName +
                                           " is not possible");
                        }
                    }
                    ...
                    if (elem != null) {
                        if (elem.isIntValue()) {
                            Bytes.pack4(buf.arr, offs,
                                        Float.floatToIntBits((float) elem.getIntValue()));
                        } else if (elem.isRealValue()) {
                            Bytes.pack4(buf.arr, offs,
                                        Float.floatToIntBits((float) elem.getRealValue()));
                        } else {
                            throwException("Conversion for field " + fieldName +
                                           " is not possible");
                        }
                ...
                case ClassDescriptor.tpDouble :
                    ...
                    if (elem != null) {
                        if (elem.isIntValue()) {
                            Bytes.pack8(buf.arr, offs,
                                        Double.doubleToLongBits((double) elem.getIntValue()));
                        } else if (elem.isRealValue()) {
                            Bytes.pack8(buf.arr, offs,
                                        Double.doubleToLongBits((double) elem.getRealValue()));
                        } else {
                            throwException("Conversion for field " + fieldName +
                                           " is not possible");
                        }
                ...
                case ClassDescriptor.tpEnum :
                    ...
                    if (elem != null) {
                        if (elem.isIntValue()) {
                            ...
                            Bytes.pack4(buf.arr, offs,
                                        Enum.valueOf((Class) fd.field.getType(),
                                                     elem.getStringValue()).ordinal());
                        } else {
                            throwException("Conversion for field " + fieldName +
                                           " is not possible");
                        }
                ...
                case ClassDescriptor.tpDate :
                    ...
                    if (elem != null) {
                        if (elem.isIntValue()) {
                            ...
                            Date date = httpFormatter.parse(elem.getStringValue(),
                                            new ParsePosition(0));
                ...
                case ClassDescriptor.tpArrayOfFloat :
                    if ((elem == null) || elem.isNullValue()) {
                        ...
                        while (--len >= 0) {
                            if (item.isIntValue()) {
                                Bytes.pack4(buf.arr, offs,
                                            Float.floatToIntBits((float) item.getIntValue()));
                            } else if (item.isRealValue()) {
                                Bytes.pack4(buf.arr, offs,
                                            Float.floatToIntBits((float) item.getRealValue()));
                            } else {
                                throwException("Conversion for field " + fieldName +
                                               " is not possible");
                            }
                ...
                case ClassDescriptor.tpArrayOfDouble :
                    if ((elem == null) || elem.isNullValue()) {
                        ...
                        while (--len >= 0) {
                            if (item.isIntValue()) {
                                Bytes.pack8(buf.arr, offs,
                                            Double.doubleToLongBits((double) item.getIntValue()));
                            } else if (item.isRealValue()) {
                                Bytes.pack8(buf.arr, offs,
                                            Double.doubleToLongBits((double) item.getRealValue()));
                            } else {
                                throwException("Conversion for field " + fieldName +
                                               " is not possible");
                            }
                    ...
                    if ((elem == null) || elem.isNullValue()) {
                        ...
                        while (--len >= 0) {
                            if (item.isNullValue()) {
                                ...
                                Date date = httpFormatter.parse(item.getStringValue(),
                                                new ParsePosition(0));
                ...
                switch (ch) {
                    case '<' :
                        ...
                        if (ch == '?') {
                            while ((ch = get()) != '?') {
                                if (ch < 0) {
                                    throw new XMLImportException(line, column,
                                                                 "Bad XML file format");
                                }
                            }
