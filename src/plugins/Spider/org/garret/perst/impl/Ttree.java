...
public class Ttree<T extends IPersistent> extends PersistentCollection<T>
    ...
    public IPersistent[] get(Object from, boolean fromInclusive, Object till,
                             boolean tillInclusive) {
    ...
    public boolean containsObject(T member) {
        return ((root != null) && (member != null))
               ? root.containsObject(comparator, member) : false;
    }
    ...
    static class TtreeIterator<T extends IPersistent> extends IterableIterator<T>
