...
public class StorageError extends RuntimeException {
    ...
    private static final String[] messageText = {
        "", "Storage not opened", "Storage already opened", "File access error", "Key not unique",
        "Key not found", "Database schema was changed for", "Unsupported type",
        "Unsupported index type", "Incompatible key type", "Not enough space",
        ...
        "Storage is used by other application", "Invalid replication node port",
        "Connection failure", "Too much objects", "Failed to insert document in full text index"
    };
