...
public class WebInterface {
    ...
    public void load() {
        ...
        toadletContainer.register(mainToadlet = new MainPageToadlet(client, spider, core),
                                  "Spider", "/spider/", true, "Spider", "Spider", true, null);
        toadletContainer.register(configToadlet = new ConfigPageToadlet(client, spider, core),
                                  "Spider", "/spider/config", true, "Configure Spider",
                                  "Configure Spider", true, null);
    }
