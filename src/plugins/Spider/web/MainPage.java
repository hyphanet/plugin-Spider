...
class MainPage implements WebPage {
        ...
        if ((addURI != null) && (addURI.length() != 0)) {
            try {
                ...
                pageMaker.getInfobox("infobox infobox-success", "URI Added",
                                     contentNode).addChild("#", "Added " + uri);
            } catch (Exception e) {
                pageMaker.getInfobox("infobox infobox-error", "Error adding URI",
                                     contentNode).addChild("#", e.getMessage());
    ...
    public void writeContent(HTTPRequest request, HTMLNode contentNode) {
        ...
        statusContent.addChild("#",
                               "Running Request: " + runningFetch.size() + "/" +
        ...
        statusContent.addChild("#",
                               ...
                               ((lastRequestFinishedAt == 0)
                                ...
                                : (TimeUtil.formatTime(System.currentTimeMillis() -
                                    lastRequestFinishedAt) + " ago")));
        statusContent.addChild("br");
        statusContent.addChild("#", "Time stalled: " + TimeUtil.formatTime(tStalled));
        statusContent.addChild("br");
        statusContent.addChild("#",
                               "Time not stalled: " + TimeUtil.formatTime(tNotStalled) + " (" +
        ...
        addForm.addChild("input", new String[] { "name", "style" }, new String[] { "addURI",
                "width: 20em;" });
        addForm.addChild("input", new String[] { "type", "value" },
                         new String[] { "submit", "Add" });
