...
public class LibraryBuffer implements FredPluginTalker {
    ...
    private void sendBuffer() {
        ...
        try {
            Logger.normal(this,
                          "Sending buffer of estimated size " + bufferUsageEstimate +
                          " bytes to Library");
    ...
    public void terminate() {
        ...
        try {
            ...
            System.err.println("Failed to determine page size during writing data to " +
                               SAVE_FILE + ": " + t);
            t.printStackTrace();
        }
        ...
        try {
            ...
            System.err.println("Failed to write pending data: " +
                               e);  // Hopefully no data loss due to NOT_PUSHED vs INDEXED.
            e.printStackTrace();
        }
